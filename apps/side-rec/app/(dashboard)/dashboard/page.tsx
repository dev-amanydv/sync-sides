...
const totalDurationMs = meetings.reduce((acc, meeting) => acc + (meeting.durationMs || 0), 0);
                ...
                {filteredMeetings.map((meeting) => (
                  ...
                  >
                    ...
                    <div className="flex gap-2 md:gap-2 flex-wrap md:flex-nowrap">
                      <button className="flex cursor-pointer rounded-md hover:bg-[#2C2C2C] gap-2 items-center border border-[#2C2C2C] px-3 md:px-4 py-2 flex-1 md:flex-none justify-center text-sm">
                      ...
                      <button className="flex rounded-md cursor-pointer hover:bg-[#2C2C2C] gap-2 items-center border border-[#2C2C2C] px-3 md:px-4 py-2 flex-1 md:flex-none justify-center text-sm">

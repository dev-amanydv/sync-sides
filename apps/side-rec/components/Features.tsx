...
const Features = () => {
  return (
    <div
      className={`grid h-auto md:h-[700px] max-w-6xl my-0 md:mb-30 md:mt-0 mx-auto w-full ${inter.className}  gap-5 grid-cols-1 md:grid-cols-3 grid-rows-5 md:grid-rows-4`}
    >
      <motion.div initial={{ opacity: 0, y: -100 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6, ease: [0, 0.3, 0.5, 1.0], }}
      viewport={{ once: true, amount: 0.2 }} className="row-span-1 md:row-span-3 rounded-xl overflow-hidden col-span-1 group">
        <div className="h-full w-full relative bg-transparent">
          ...
          <div className="z-50 px-5 relative h-full flex flex-col  justify-end">
            <motion.h1 className="font-semibold text-2xl w-3/4 text-gray-300 transform transition-all duration-300 group-hover:-translate-y-20">
      ...
      >
        ...
        <div className="z-50 py-1 relative px-4 h-full flex flex-col justify-center">
          <motion.h1 initial={{y:50}} className="font-semibold group-hover:-translate-y-16 transition-all duration-300  text-2xl w-full text-gray-300">
      ...
      >
        ...
        <div className="z-50  py-1 relative px-4 h-full flex flex-col justify-end">
          <motion.h1 initial={{y:65}}  className="font-semibold group-hover:-translate-y-20 text-2xl transition-all duration-300  w-full text-gray-300">
      ...
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6, ease: [0, 0.3, 0.5, 1.0], }}
      viewport={{ once: true, amount: 0.2 }} className="row-span-1 group md:row-span-3 px-3 py-4 relative rounded-xl overflow-hidden rol-span-1 md:col-span-1 bg-cyan-950" style={{
          background:
      ...
      >
        ...
        <div className="z-50 pb-5 gap-5 py-1 relative px-4 h-full flex flex-col justify-end">
          <motion.h1 initial={{y:60}} className="font-semibold group-hover:-translate-y-14 transition-all duration-300 text-2xl w-full text-gray-300">
      ...
      whileInView={{ opacity: 1, x: 0 }}
      transition={{ duration: 0.6, ease: [0, 0.3, 0.5, 1.0], }}
      viewport={{ once: true, amount: 0.2 }} className="col-span-1 group md:col-span-2 rounded-xl relative overflow-hidden row-span-1 md:row-span-1 bg-cyan-950"style={{
          background:
      ...
      >
        ...
        <div className="z-50 pb-5 gap-5 py-1 backdrop-blur-[4px] relative px-4 h-full flex flex-col justify-end">
          <motion.h1 initial={{y:50}} className="font-semibold group-hover group-hover:-translate-y-10 transition-all duration-300 text-2xl w-full text-gray-300">

  ...
  return (
    <motion.div initial={{y:-100}} animate={{y:0}} transition={{duration:0.3, delay:0.5}} className='w-full max-w-7xl mx-auto flex items-center justify-between h-16'>
      ...
      <div className='hidden md:flex items-center gap-5'>
        <button className='text-white cursor-pointer hover:bg-transparent border-[1px] border-transparent hover:border-[1px] hover:border-cyan-500 transition ease-in-out duration-300 px-4 py-2 rounded-full' onClick={() => {
          if (session) {

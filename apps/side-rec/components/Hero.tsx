...
const Hero = () => {
  return (
    <motion.div initial={{y:50, opacity:0}} animate={{y:0, opacity:1}} transition={{duration:0.3,delay:0.5}} className={`flex flex-col my-28 md:my-40 w-full items-center gap-10 ${inter.className}`}>
